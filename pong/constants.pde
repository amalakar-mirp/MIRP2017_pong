...
// Velocity Cnstants
float BALL_VELOCITY = 6; //This is the MAX speed of the ball.
...
float ballVx=4, ballVy=BALL_VELOCITY; // ballVx is always BALL_VELOCTY or -BALL_VELOCITY; ballVy varies.
float ballRadius = 10;
int ballColor = 255;
int gameState=1;
